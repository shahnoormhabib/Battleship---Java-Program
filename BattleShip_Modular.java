...
class BattleShip_Modular {
   public int [][] OceanMap=new int[10][10];
   static int max=10;
  ...
  public void Battle(){
	 ...
	 while(endGame==false){	
        ...
        computerScore=this.ComputerPlay(ships, computerScore);
		displayOceanMap();
		System.out.println(" ");
       if(ships[0]==0){
  ...
  public int ComputerPlay(int [] ships, int cScore){
